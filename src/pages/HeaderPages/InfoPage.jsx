...
const InfoPage = () => {
  return (
    <div className="h-screen w-full px-4 pt-32 bg-gradient-to-b from-gray-100 to-gray-300">
      <div className="mx-auto w-full max-w-lg divide-y divide-gray-300 rounded-xl bg-white shadow-lg">
        {/* Первая секция */}
        <Disclosure>
          {({ open }) => (
            <div className="p-6">
              <Disclosure.Button className="group flex w-full items-center justify-between border-b border-gray-300 pb-4">
                <span className="text-lg font-semibold bg-bordo text-white px-2 py-1 rounded transition-colors">
                  Образовательная программа Web-разработчик:
                </span>
                <motion.div
                  ...
                  <Disclosure.Panel static>
                    ...
                    >
                      <p className="text-base font-medium text-blue-600 mb-4">
                        Web-разработчик и мультимедийных интерфейсов
                      </p>
        ...
        <Disclosure>
          {({ open }) => (
            <div className="p-6">
              <Disclosure.Button className="group flex w-full items-center justify-between border-b border-gray-300 pb-4">
                <span className="text-lg font-semibold bg-bordo text-white px-2 py-1 rounded transition-colors">
                  Образовательная программа Frontend-разработчик:
                </span>
                <motion.div
                  animate={{ rotate: open ? -180 : 0 }}
                  transition={{ duration: 0.3 }}
              ...
              <AnimatePresence>
                {open && (
                  <Disclosure.Panel static>
                    ...
                    >
                      <p className="text-base font-medium text-blue-600 mb-4">
                        Frontend-разработчик и код для интерфейсов:
                      </p>
                      <div className="flex flex-col gap-2">
                        {[
                          {
        ...
        <Disclosure>
          {({ open }) => (
            <div className="p-6">
              <Disclosure.Button className="group flex w-full items-center justify-between border-b border-gray-300 pb-4">
                <span className="text-lg font-semibold bg-bordo text-white px-2 py-1 rounded transition-colors">
                  Образовательная программа Backend-разработчик:
                </span>
                <motion.div
                  animate={{ rotate: open ? -180 : 0 }}
                  transition={{ duration: 0.3 }}
              ...
              <AnimatePresence>
                {open && (
                  <Disclosure.Panel static>
                    ...
                    >
                      <p className="text-base font-medium text-blue-600 mb-4">
                        Backend-разработчик и код для серверной логики:
                      </p>
                      <div className="flex flex-col gap-2">
                        {[
                          {
        ...
        <Disclosure>
          {({ open }) => (
            <div className="p-6">
              <Disclosure.Button className="group flex w-full items-center justify-between border-b border-gray-300 pb-4">
                <span className="text-lg font-semibold bg-bordo text-white px-2 py-1 rounded transition-colors">
                  Образовательная программа Автослесаря:
                </span>
                <motion.div
                  animate={{ rotate: open ? -180 : 0 }}
                  transition={{ duration: 0.3 }}
              ...
              <AnimatePresence>
                {open && (
                  <Disclosure.Panel static>
                    ...
                    >
                      <p className="text-base font-medium text-blue-600 mb-4">
                        Автослесарь и ремонт автомобилей:
                      </p>
                      <div className="flex flex-col gap-2">
                        {[
                          {
        ...
        <Disclosure>
          {({ open }) => (
            <div className="p-6">
              <Disclosure.Button className="group flex w-full items-center justify-between border-b border-gray-300 pb-4">
                <span className="text-lg font-semibold bg-bordo text-white px-2 py-1 rounded transition-colors">
                  Образовательная программа Технология дизайна:
                </span>
                <motion.div
                  animate={{ rotate: open ? -180 : 0 }}
                  transition={{ duration: 0.3 }}
              ...
              <AnimatePresence>
                {open && (
                  <Disclosure.Panel static>
                    ...
                    >
                      <p className="text-base font-medium text-blue-600 mb-4">
                        Технология дизайна и визуальные решения:
                      </p>
                      <div className="flex flex-col gap-2">
                        {[
                          {
        ...
        <Disclosure>
          {({ open }) => (
            <div className="p-6">
              <Disclosure.Button className="group flex w-full items-center justify-between border-b border-gray-300 pb-4">
                <span className="text-lg font-semibold bg-bordo text-white px-2 py-1 rounded transition-colors">
                  Образовательная программа Системного администратора:
                </span>
                <motion.div
                  animate={{ rotate: open ? -180 : 0 }}
                  transition={{ duration: 0.3 }}
              ...
              <AnimatePresence>
                {open && (
                  <Disclosure.Panel static>
                    ...
                    >
                      <p className="text-base font-medium text-blue-600 mb-4">
                        Системный администратор и работа с IT-инфраструктурой:
                      </p>
                      <div className="flex flex-col gap-2">
                        {[
                          {
        ...
        <Disclosure>
          {({ open }) => (
            <div className="p-6">
              <Disclosure.Button className="group flex w-full items-center justify-between border-b border-gray-300 pb-4">
                <span className="text-lg font-semibold bg-bordo text-white px-2 py-1 rounded transition-colors">
                  Образовательная программа Оператора мехатроники и
                  робототехники:
                </span>
                <motion.div
                  animate={{ rotate: open ? -180 : 0 }}
              ...
              <AnimatePresence>
                {open && (
                  <Disclosure.Panel static>
                    ...
                    >
                      <p className="text-base font-medium text-blue-600 mb-4">
                        Оператор мехатроники и робототехники - работа с
                        автоматикой и роботами:
                      </p>
                      <div className="flex flex-col gap-2">
                        {[
                          {
              ...
              <AnimatePresence>
                {open && (
                  <Disclosure.Panel static>
                    ...
                    >
                      <p className="text-base font-medium text-blue-600 mb-4">
                        Мехатроника и Робототехника - управление умными
                        машинами:
                      </p>
                      <div className="flex flex-col gap-2">
                        {[
        ...
        <Disclosure>
          {({ open }) => (
            <div className="p-6">
              <Disclosure.Button className="group flex w-full items-center justify-between border-b border-gray-300 pb-4">
                <span className="text-lg font-semibold bg-bordo text-white px-2 py-1 rounded transition-colors">
                  Образовательная программа Разработчик мобильных приложений:
                </span>
                <motion.div
                  animate={{ rotate: open ? -180 : 0 }}
                  transition={{ duration: 0.3 }}
              ...
              <AnimatePresence>
                {open && (
                  <Disclosure.Panel static>
                    ...
                    >
                      <p className="text-base font-medium text-blue-600 mb-4">
                        Разработчик мобильных приложений - создание умных
        ...
        <Disclosure>
          {({ open }) => (
            <div className="p-6">
              <Disclosure.Button className="group flex w-full items-center justify-between border-b border-gray-300 pb-4">
                <span className="text-lg font-semibold bg-bordo text-white px-2 py-1 rounded transition-colors">
                  Образовательная программа Конструирование швейных изделий с
                  применением IT технологий:
                </span>
                <motion.div
                  animate={{ rotate: open ? -180 : 0 }}
                  transition={{ duration: 0.3 }}
              ...
              <AnimatePresence>
                {open && (
                  <Disclosure.Panel static>
                    ...
                    >
                      <p className="text-base font-medium text-blue-600 mb-4">
                        Конструирование швейных изделий с применением IT
                        технологий - технологии точного кроя и дизайна:
                      </p>
                      <div className="flex flex-col gap-2">
                        {[
                          {
              ...
              <AnimatePresence>
                {open && (
                  <Disclosure.Panel static>
                    ...
                    >
                      <p className="text-base font-medium text-blue-600 mb-4">
                        Информационная безопасность - защита данных и цифровых
                        систем:
                      </p>
                      <div className="flex flex-col gap-2">
                        {[
        ...
        <Disclosure>
          {({ open }) => (
            <div className="p-6">
              <Disclosure.Button className="group flex w-full items-center justify-between border-b border-gray-300 pb-4">
                <span className="text-lg font-semibold bg-bordo text-white px-2 py-1 rounded transition-colors">
                  Образовательная программа "Слесарь по техническому
                  обслуживанию и ремонту горного оборудования и спецтехники":
                </span>
                <motion.div
                  animate={{ rotate: open ? -180 : 0 }}
                  transition={{ duration: 0.3 }}
              ...
              <AnimatePresence>
                {open && (
                  <Disclosure.Panel static>
                    ...
                    >
                      <p className="text-base font-medium text-blue-600 mb-4">
                        Слесарь по техническому обслуживанию и ремонту горного
                        оборудования и спецтехники - надёжность машин под землёй
                        и на поверхности:
                      </p>
                      <div className="flex flex-col gap-2">
                        {[
        ...
        <Disclosure>
          {({ open }) => (
            <div className="p-6">
              <Disclosure.Button className="group flex w-full items-center justify-between border-b border-gray-300 pb-4">
                <span className="text-lg font-semibold bg-bordo text-white px-2 py-1 rounded transition-colors">
                  Образовательная программа "Слесарь по ремонту автотранспортных
                  средств":
                </span>
                <motion.div
                  animate={{ rotate: open ? -180 : 0 }}
              ...
              <AnimatePresence>
                {open && (
                  <Disclosure.Panel static>
                    ...
                    >
                      <p className="text-base font-medium text-blue-600 mb-4">
                        Слесарь по ремонту автотранспортных средств - чтобы
                        техника всегда была на ходу:
                      </p>
                      <div className="flex flex-col gap-2">
                        {[
                          {
